...
public class UpdateCheck {
    ...
    private UpdateCheck(@Nonnull String PluginName) {
        this.javaPlugin = Bukkit.getPluginManager().getPlugin(Objects.requireNonNull(PluginName, "javaPlugin"));
        this.currentVersion = javaPlugin.getDescription().getVersion();
    }

    public static UpdateCheck of(@Nonnull String PluginName) {
        return new UpdateCheck(PluginName);
    }
